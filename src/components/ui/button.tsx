...
const buttonVariants = cva(
  'inter font-bold inline-flex items-center justify-center text-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
        ...
        dark: 'w-full font-bold bg-brand-600 text-secondary-200 text-sm inter text-secondary-200 hover:bg-gray-900 hover:shadow-[2px_2px_black]',
      },
      size: {
